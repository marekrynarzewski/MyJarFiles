...
public class JacksonUtility
{
	 ...
	 * 
	 * @param dataMap
	 *        ; can be null/empty, but will result in an empty String;
	 *        otherwise, must be Strings mapped to arbitrary Objects.
	 * @return the json-string representing the data, or an empty-string; will
	 *         not return null
	 * @throws JacksonUtilityException
	 *         if there was an error converting the map-data into a json-string
	 */
	public static String GET_JSON_STRING_FROM_MAP(Map<String, Object> dataMap)
			throws JacksonUtilityException
	{
		...
		catch (Throwable t)
		{
			...
			String msg = "unable to convert data from map into json: "
					+ dataMap.toString();
			LOGGER.warn(msg);
	 ...
	 * 
	 * @param jsonResponse
	 *        ; can be null/empty, but will result in an empty-map;
	 * @return Strings mapped to arbitrary Objects
	 * 
	 * @throws JacksonUtilityException
	 *         if there was an error converting the json-string into map-data
	 */
	@SuppressWarnings ("unchecked")
	public static Map<String, Object>
			GET_JSON_STRING_AS_MAP(String jsonResponse)
					throws JacksonUtilityException
	{
		...
		{
			LOGGER.warn("jsonResponse was null/empty, returning empty map; was: '"
					+ jsonResponse + "'");
			return new HashMap<String, Object>(); // don't want to return null
													// to avoid NPEs
		}
