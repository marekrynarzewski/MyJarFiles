...
public class Parity 
{
	...
	private static void body()
	{
		...
		currentCost = 0;
		showMenu();
		int state = promptInt("Wyb�r: ");
		while (state != 0)
		{
			showElement(state);
			showMenu();
			state = promptInt("Wyb�r: ");
		}
		finishGame();
	}
	...
	{
		promptln("Menu:");
		promptln("0 - zako�cz gr�.");
		promptln("1 - zgadnij pod kt�rymi kubkami jest kulka");
		promptln("2 - popro� o podpowied�");
	}
	...
	private static void askHint() 
	{
		...
		try 
		{
			...
			promptln("Parzysto�� wyst�pie� kulek w zakresie "+from+", "+to+" wynosi: "+parity);
		}
		...
		{
			promptln("Ju� wykorzysta�e� podpowiedz dla tego zakresu");
		}
	}
	...
	private static void finishGame() 
	{
		...
		promptln("Zako�czy�e� gr� z kosztem "+currentCost);
		System.exit(0);
	}
